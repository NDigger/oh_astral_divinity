...
function addPattern(key)
    ...
    elseif key == 300 then preDelayX2() singleTwoParallelWalls(3.03 * THICKNESS / 40, math.random(2, 4), THICKNESS * 0.66)
    elseif key == 301 then preDelayFull() singleOneOpenSide(3.03 * THICKNESS / 40, math.random(2, 4), THICKNESS * 0.66)
    elseif key == 302 then preDelayX2() singleVortex(3.03 * THICKNESS / 40, math.random(2, 4), THICKNESS * 0.66)
    elseif key == 303 then preDelayX2() singleAlternate(3.03 * THICKNESS / 40, math.random(2, 4), THICKNESS * 0.66)
